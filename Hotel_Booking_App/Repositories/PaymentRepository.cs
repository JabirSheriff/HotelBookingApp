        ...
        public async Task<List<PaymentResponseDto>> GetUnpaidBookingsAsync()
        {
            return await _context.Bookings
                ...
                .Select(b => new PaymentResponseDto
                {
                    ...
                    PaymentDate = null, // ✅ Now allowed since DTO property is nullable
                    PaymentStatus = "Unpaid",
                    CheckInDate = b.CheckInDate, // ✅ Ensures proper DateTime mapping
                    CheckOutDate = b.CheckOutDate, // ✅ Ensures proper DateTime mapping
                    RoomPricePerNight = b.BookingRooms.FirstOrDefault() != null
                        ? b.BookingRooms.FirstOrDefault().Room.PricePerNight
                        : 0 // ✅ Prevents First() exception
                })
                .ToListAsync();
        }
